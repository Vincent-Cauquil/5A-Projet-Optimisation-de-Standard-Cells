...
class CellModifier:
    ...
    def get_transistor_lenghts(self) -> Dict[str, float]:
        """
        Retourne les largeurs actuelles de tous les transistors.
        
        Returns:
            Dict {'X0': 15000, 'X1': 15000.0, ...} en nanomètres
        """
        return {name: params['l'] for name, params in self.transistors.items()}
    ...
    def modify_width(self, transistor_name: str, new_width_nm: float) -> None:
        ...
        MAX_WIDTH = 1000000.0 # 10µm maximum raisonnable
